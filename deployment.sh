...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='tixoncash.conf'
CONFIGFOLDER='/root/.tixoncash'
COIN_DAEMON='tixoncashd'
COIN_CLI='tixoncash-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/tixoncoin/tixoncash.git'
COIN_TGZ='https://github.com/tixoncoin/tixoncash/releases/download/v1.0.0/Linux.zip'
...
update_config() {
  ...
  echo  "" >> $CONFIGFOLDER/$CONFIG_FILE
  echo addnode=128.199.61.189 >> $CONFIGFOLDER/$CONFIG_FILE
  echo addnode=188.166.96.226 >> $CONFIGFOLDER/$CONFIG_FILE
  echo addnode=188.166.120.17 >> $CONFIGFOLDER/$CONFIG_FILE
  echo addnode=188.166.127.127 >> $CONFIGFOLDER/$CONFIG_FILE
  echo addnode=128.199.48.70 >> $CONFIGFOLDER/$CONFIG_FILE
